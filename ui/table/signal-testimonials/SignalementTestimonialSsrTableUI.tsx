      ...
      <div className="p-6">
        <Card className="border border-gray-200 shadow-sm">
          <CardBody className="text-center py-12">
            ...
            <p className="text-sm text-gray-500">Il n'y a actuellement aucun signalement de témoignage à traiter</p>
          </CardBody>
        </Card>
      </div>
    );
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-800 mb-1">Signalements Témoignages</h1>
          <p className="text-sm text-gray-600">Gestion et suivi des signalements de témoignages</p>
        </div>
      ...
      <Card className="border border-gray-200 shadow-sm">
        <CardBody className="p-0">
          <Table 
            aria-label="Liste des Signalements Testimonials" 
            isStriped
            removeWrapper
                ...
                >
                  ...
                  <TableCell className="py-4 px-6">
                    <div className="space-y-1">
                      <span className="text-gray-700 text-sm max-w-md line-clamp-2 block">
                        {item.testimonial.description ?? "Sans description"}
                      </span>
                      {item.testimonial.link && (
                        <a 
                          href={`${api_url}/${item.testimonial.link}`} 
                          target="_blank" 
                          rel="noreferrer"
