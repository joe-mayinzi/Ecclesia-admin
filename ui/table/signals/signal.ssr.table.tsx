      ...
      <div className="p-6">
        <Card className="border border-gray-200 shadow-sm">
          <CardBody className="text-center py-12">
            ...
            <p className="text-sm text-gray-500">Il n'y a actuellement aucun signalement à traiter</p>
          </CardBody>
        </Card>
      </div>
    );
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-800 mb-1">Signalements</h1>
          <p className="text-sm text-gray-600">Gestion et suivi des signalements de contenu</p>
        </div>
      ...
      <Card className="border border-gray-200 shadow-sm">
        <CardBody className="p-0">
          <Table 
            aria-label="Liste des Signalements" 
            isStriped
            removeWrapper
            ...
            >
              {signalements.map((item, index) => (
                ...
                >
                  ...
                  <TableCell className="py-4 px-6">
                    <span className="text-gray-800 font-medium text-sm">{item.videos?.titre ?? "-"}</span>
                  </TableCell>
                  <TableCell className="py-4 px-6">
                    <span className="text-gray-600 text-sm">{item.videos?.auteur ?? "-"}</span>
                  </TableCell>
                  <TableCell className="py-4 px-6">
